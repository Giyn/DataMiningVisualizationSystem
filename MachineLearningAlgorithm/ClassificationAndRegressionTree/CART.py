...
from model_assessment import reg


class TreeNode:
    def __init__(self, left_child=None, right_child=None, col=-1, value=None, data=None,
                 result=None):
    ...
    def fit(self, X_train, y_train):
        ...
        def create_tree(data, current_depth):
            ...
            if best_gain > self.min_impurity:
                ...
                return TreeNode(true_branch, false_branch, col=best_feature[0],
                                value=best_feature[1], data=data)
